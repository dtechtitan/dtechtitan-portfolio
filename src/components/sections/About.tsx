      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
        ...
        <div className="font-sans text-base md:text-lg text-brand-text-secondary leading-relaxed flex flex-col gap-5">
          <p>
            ...
            Science student at the University of Lagos, and most of what I build
            lives at the intersection of data, code, and things people actually
            use.
          </p>
          <p>
          ...
          <p>
            I'm currently doing an ML-track internship at FlyRank, and building
            out a portfolio of projects that range from real estate market
            analysis to fraud detection to local business dashboards.
          </p>
        </div>
      </div>
